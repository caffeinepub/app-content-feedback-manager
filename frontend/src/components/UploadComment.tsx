  ...
  return (
    <div className="space-card p-0 overflow-hidden">
      ...
      >
        ...
        <div>
          <h3 className="font-display font-semibold text-base text-foreground">Upload Comment</h3>
          <p className="text-xs text-muted-foreground">Share your comment or feedback</p>
        </div>
      </div>
      ...
      <div className="p-5 space-y-4">
        ...
        {status === 'success' && (
          <div className="flex items-center gap-2 rounded-xl p-3 animate-fade-in" style={{ background: 'oklch(0.75 0.22 155 / 0.1)', border: '1px solid oklch(0.75 0.22 155 / 0.3)' }}>
            ...
            <p className="text-sm" style={{ color: 'oklch(0.75 0.22 155)' }}>Comment uploaded successfully!</p>
          </div>
        )}
        {status === 'error' && (
          <div className="flex items-center gap-2 rounded-xl p-3 animate-fade-in" style={{ background: 'oklch(0.6 0.22 25 / 0.1)', border: '1px solid oklch(0.6 0.22 25 / 0.3)' }}>
            ...
            <p className="text-sm" style={{ color: 'oklch(0.6 0.22 25)' }}>Failed to upload comment. Please try again.</p>
          </div>
        )}
      </div>
    </div>
