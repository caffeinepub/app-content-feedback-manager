  ...
  return (
    <div className="space-y-6 animate-fadeInUp">
      ...
      <div className="text-center pt-2">
        <h2 className="font-orbitron font-bold text-2xl gradient-heading">Upload Section</h2>
        <p className="text-sm font-rajdhani mt-1" style={{ color: 'oklch(0.55 0.04 260)' }}>
      ...
      <div className="glass-card p-0 overflow-hidden rounded-2xl">
        ...
        >
          <div
            ...
            style={{ background: 'linear-gradient(135deg, oklch(0.70 0.20 185), oklch(0.75 0.18 65))' }}
          >
            <FileText className="w-5 h-5" style={{ color: 'oklch(0.08 0.02 260)' }} />
          </div>
          <div>
            <h3 className="font-orbitron font-bold text-sm" style={{ color: 'oklch(0.85 0.05 80)' }}>Bulk Comments</h3>
            <p className="text-xs font-rajdhani" style={{ color: 'oklch(0.55 0.04 260)' }}>Upload a .txt or .csv file to add templates to a list</p>
          </div>
        </div>
        ...
        <div className="p-5 space-y-4">
          {isLoading ? (
            <div className="space-y-3">
              <Skeleton className="h-10 w-full" style={{ background: 'oklch(0.16 0.03 260)' }} />
              <Skeleton className="h-10 w-full" style={{ background: 'oklch(0.16 0.03 260)' }} />
            </div>
          ) : (
            <>
              <div className="space-y-1.5">
                <label className="text-xs font-rajdhani font-600 uppercase tracking-wider" style={{ color: 'oklch(0.60 0.04 260)' }}>
                  Target Comment List
                </label>
                <select
                  value={selectedList}
              ...
              <div className="space-y-1.5">
                ...
                >
                  <FileText className="w-10 h-10 mx-auto mb-2" style={{ color: 'oklch(0.45 0.04 260)' }} />
                  {fileName ? (
                    <p className="font-rajdhani font-600 text-sm" style={{ color: 'oklch(0.85 0.05 80)' }}>{fileName}</p>
                  ) : (
                    <>
                      <p className="font-rajdhani text-sm" style={{ color: 'oklch(0.55 0.04 260)' }}>Click to select a .txt or .csv file</p>
                      <p className="text-xs font-rajdhani mt-1" style={{ color: 'oklch(0.40 0.04 260)' }}>Each line will be added as a template</p>
                    </>
                  )}
                </div>
                <input
              ...
              <button
                ...
                style={{
                  background: (!selectedList || !fileName)
                    ? 'oklch(0.16 0.03 260)'
                    : 'linear-gradient(135deg, oklch(0.75 0.18 65), oklch(0.70 0.20 185))',
                  color: (!selectedList || !fileName) ? 'oklch(0.40 0.04 260)' : 'oklch(0.08 0.02 260)',
                }}
              >
                {status === 'processing' ? (
                  <>
              ...
              {status === 'success' && (
                <div className="flex items-center gap-2 rounded-xl p-3 animate-fadeIn" style={{ background: 'oklch(0.65 0.18 145 / 0.1)', border: '1px solid oklch(0.65 0.18 145 / 0.3)' }}>
                  <CheckCircle className="w-4 h-4 flex-shrink-0" style={{ color: 'oklch(0.72 0.20 145)' }} />
                  <p className="text-sm font-rajdhani" style={{ color: 'oklch(0.72 0.20 145)' }}>{message}</p>
                </div>
              )}
              {status === 'error' && (
                <div className="flex items-center gap-2 rounded-xl p-3 animate-fadeIn" style={{ background: 'oklch(0.55 0.22 25 / 0.1)', border: '1px solid oklch(0.55 0.22 25 / 0.3)' }}>
                  <AlertCircle className="w-4 h-4 flex-shrink-0" style={{ color: 'oklch(0.65 0.22 25)' }} />
                  <p className="text-sm font-rajdhani" style={{ color: 'oklch(0.65 0.22 25)' }}>{message}</p>
                </div>
              )}
            </>
          )}
      ...
      <div className="glass-card p-0 overflow-hidden rounded-2xl">
        ...
        >
          <div
            ...
            style={{ background: 'linear-gradient(135deg, oklch(0.70 0.20 185), oklch(0.75 0.18 65))' }}
          >
            <ImageIcon className="w-5 h-5" style={{ color: 'oklch(0.08 0.02 260)' }} />
          </div>
          <div>
            <h3 className="font-orbitron font-bold text-sm" style={{ color: 'oklch(0.85 0.05 80)' }}>Upload Rating Image</h3>
            <p className="text-xs font-rajdhani" style={{ color: 'oklch(0.55 0.04 260)' }}>Upload your rating image with your name</p>
          </div>
        </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl font-orbitron font-bold text-xs uppercase tracking-wider transition-all duration-300 hover-lift flex items-center justify-center gap-2"
            style={{
              background: (!imageName.trim() || !imageFileName)
                ? 'oklch(0.16 0.03 260)'
                : 'linear-gradient(135deg, oklch(0.75 0.18 65), oklch(0.70 0.20 185))',
              color: (!imageName.trim() || !imageFileName) ? 'oklch(0.40 0.04 260)' : 'oklch(0.08 0.02 260)',
            }}
          >
          ...
          {imageStatus === 'success' && (
            <div className="flex items-center gap-2 rounded-xl p-3 animate-fadeIn" style={{ background: 'oklch(0.65 0.18 145 / 0.1)', border: '1px solid oklch(0.65 0.18 145 / 0.3)' }}>
              <CheckCircle className="w-4 h-4 flex-shrink-0" style={{ color: 'oklch(0.72 0.20 145)' }} />
              <p className="text-sm font-rajdhani" style={{ color: 'oklch(0.72 0.20 145)' }}>{imageMessage}</p>
            </div>
          )}
          {imageStatus === 'error' && (
            <div className="flex items-center gap-2 rounded-xl p-3 animate-fadeIn" style={{ background: 'oklch(0.55 0.22 25 / 0.1)', border: '1px solid oklch(0.55 0.22 25 / 0.3)' }}>
              <AlertCircle className="w-4 h-4 flex-shrink-0" style={{ color: 'oklch(0.65 0.22 25)' }} />
              <p className="text-sm font-rajdhani" style={{ color: 'oklch(0.65 0.22 25)' }}>{imageMessage}</p>
            </div>
          )}
        </div>
      </div>
