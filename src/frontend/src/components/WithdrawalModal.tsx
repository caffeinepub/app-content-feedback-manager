        ...
        <div className="glass-card-gold p-6 relative">
          ...
          {!submitted ? (
            <>
              ...
              <div className="text-center mb-6">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, oklch(0.75 0.18 65 / 0.2), oklch(0.70 0.20 185 / 0.2))",
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label
                    ...
                    className="block text-sm font-rajdhani font-600 mb-2"
                    style={{ color: "oklch(0.75 0.10 80)" }}
                  >
                    <Wallet
                  ...
                  {validationError && (
                    <p
                      className="mt-1.5 text-xs font-rajdhani animate-fadeIn"
                  ...
                  <p
                    className="mt-1.5 text-xs font-rajdhani"
            ...
            <div className="text-center py-4 animate-fadeInUp">
              ...
              <p
                className="text-sm font-rajdhani mb-2"
                style={{ color: "oklch(0.60 0.04 260)" }}
              >
