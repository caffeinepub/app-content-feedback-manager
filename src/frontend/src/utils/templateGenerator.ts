...
const featuresPhrases = {
  ...
  neutral: [
    ...
    "has limited but functional features",
  ],
  critical: [
...
const supportPhrases = {
  ...
  neutral: [
    "has average support",
    "responds eventually",
    "has basic help resources",
    "support is hit or miss",
    "has some documentation",
  ],
  critical: [
    "has poor customer support",
    "never responds to issues",
    "has unhelpful support",
...
function getPhrases(category: Category, tone: Tone): string[] {
  switch (category) {
    case "performance":
      return performancePhrases[tone];
    case "ui":
      return uiPhrases[tone];
    case "features":
      return featuresPhrases[tone];
    case "support":
      return supportPhrases[tone];
  }
}
...
function getAdjectives(tone: Tone): string[] {
  switch (tone) {
    ...
    case "neutral":
      return neutralAdjectives;
    case "critical":
      return criticalAdjectives;
  }
}
