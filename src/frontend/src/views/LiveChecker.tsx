            ...
            style={{
              background:
                mode === m
                  ...
                  : "transparent",
              color:
                mode === m ? "oklch(0.90 0.10 80)" : "oklch(0.50 0.04 260)",
              border:
                mode === m
                  ? "1px solid oklch(0.75 0.18 65 / 0.3)"
                  ...
                  <div
                    ...
                    style={{
                      background: result.found
                        ...
                        : "oklch(0.14 0.03 260 / 0.5)",
                      border: `1px solid ${result.found ? "oklch(0.65 0.18 145 / 0.25)" : "oklch(0.28 0.05 260 / 0.4)"}`,
                    }}
                  >
                    <div className="flex items-center gap-2">
                      {result.found ? (
                    ...
                    style={{
                      background:
                        found.length > 0
                          ? "oklch(0.65 0.18 145 / 0.08)"
                          : "oklch(0.14 0.03 260 / 0.5)",
                      border: `1px solid ${found.length > 0 ? "oklch(0.65 0.18 145 / 0.25)" : "oklch(0.28 0.05 260 / 0.4)"}`,
                    }}
                  >
                  ...
                  <div key={app.name} className="animate-fadeInUp">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5">
                      {app.usernames.map((username, idx) => (
                        <div
                          key={username}
                          className="px-3 py-1.5 rounded-lg text-xs font-rajdhani flex items-center gap-1.5 bg-card border border-border text-card-foreground"
                        >
